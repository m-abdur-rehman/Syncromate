...
const Header = () => {
  ...
  return (
    <div id="header">
      <header className={`inset-x-0 top-0 z-50 ${isScrolled ? 'fixed bg-white shadow-md' : 'absolute'}`}>
        <nav aria-label="Global" className="flex bg-white items-center justify-between p-4 lg:px-6" id="nav">
